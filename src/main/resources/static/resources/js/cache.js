...
layui.use(['form','jquery',"layer"],function() {
    ...
    //锁屏
    function lockPage(){
        var html='<div class="admin-header-lock" id="lock-box">'+
            '<div class="admin-header-lock-img"><img src="images/face.jpg" class="userAvatar"/></div>'+
            '<div class="admin-header-lock-name" id="lockUserName">cccc</div>'+
            '<div class="input_btn">'+
        ...
        layer.open({
            ...
            success : function(){
                ...
                $.get('/user/getNowUser',function (res) {
                    ...
                    $("#lockUserName").html(res.name);
                    var imgpath = res.imgpath;
                    $('.userAvatar').attr('src','/file/showImageByPath?path='+imgpath);
